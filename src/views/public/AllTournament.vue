  ...
  <div class="alltournament">
      <div class="section_bottom_wrap">
        ...
        <div class="nav desktop">
            <div class="nav-links">
                <router-link data-animation="ripple"  tag="a" :to="{ name: 'PNAllTournament',params: {game: game}  }"  active-class="active" exact>ALL TOURNAMENTS</router-link>
                <router-link data-animation="ripple"  tag="a" :to="{ name: 'PUpcoming',params: {game: game}  }"  active-class="active" exact>UPCOMING</router-link>
                <router-link data-animation="ripple"  tag="a" :to="{ name: 'POngoing',params: {game: game}  }"  active-class="active" exact>ON GOING</router-link>
                <router-link data-animation="ripple"  tag="a" :to="{ name: 'PCompleted',params: {game: game}  }"  active-class="active" exact>COMPLETED</router-link>
            </div>
        </div>
...
import Games from '../../components/tournament/Games.vue';
// @ is an alias to /src
...
export default {
  ...
  methods: {
    ...
    Check() {
        ...
        if (!data.length > 0) {
             this.$router.push({ name: 'PNAllTournament', params: { game: this.game } });
        }
    },
  },
  mounted() {
