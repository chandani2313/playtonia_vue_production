<template>
  <div class="tournament">
      <TopSection v-if="tournament" :tournament=tournament @reload="Tournament()" />
      <div class="bottom-container">
          <div class="bottom-wrap">
            <div class="nav">
                <div class="nav-links">
                    <router-link data-animation="ripple"  tag="a" :to="{ name: 'TOverview' ,params: {id: this.$route.params.id}}"  active-class="active" exact>overview</router-link>
                    <router-link data-animation="ripple"  tag="a" :to="{ name: 'Prize' ,params: {id: this.$route.params.id}}"  active-class="active" exact>prize</router-link>
                    ...
                    <router-link data-animation="ripple"  tag="a" :to="{ name: 'Brackets' ,params: {id: this.$route.params.id}}"  active-class="active" exact>brackets</router-link>
                    <router-link data-animation="ripple"  tag="a" :to="{ name: 'Schedule' ,params: {id: this.$route.params.id}}"  active-class="active" exact>schedule</router-link>
                    ...
                    <router-link data-animation="ripple"  tag="a" :to="{ name: 'Info' ,params: {id: this.$route.params.id}}"  active-class="active" exact>info</router-link>
                </div>
            </div>
            <Navigation v-if="id" :menus=menu :total=5 :alias=id />
...
import Navigation from '../components/tournament/Navigation.vue';
// @ is an alias to /src
...
export default {
  ...
  data() {
    return {
        ...
        menu: [{
          name: 'TOverview', title: 'overview', order: 1,
          },
          {
            name: 'Prize', title: 'Prize', order: 2,
            },
            {
            name: 'Brackets', title: 'Brackets', order: 4,
            },
            {
            name: 'Schedule', title: 'Schedule', order: 5,
            },
            {
            name: 'Participants', title: 'Participants', order: 3,
            },
            {
            name: 'Info', title: 'Info', order: 5,
            }],
    };
  },
  components: {
  ...
  mounted() {
      ...
      if (!localStorage.getItem('token')) {
          this.$router.push({ name: 'PTournament', params: { id: this.$route.params.id } });
      }
  },
};
</script>
