      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">Fill the following fields to join the tournament.</div>
                ...
                <div class="table__body">
                    <form novalidate>
                        <div class="input-wrapper">
                            ...
                            <span class="floating-label"   >PUBG MOBILE IGN</span>
                            <div class='validator error' v-if="pubgm_ign_error" >{{pubgm_ign_error}}</div>
                        </div>
                        <div class="input-wrapper">
                            <input type="number" required v-model="pubgm_id" />
                            <span class="floating-label"   >PUBG MOBILE ID</span>
                            <div class='validator error' v-if="pubgm_id_error" >{{pubgm_id_error}}</div>
                        </div>
...
export default {
  ...
  methods: {
      ...
      Save() {
          if (this.pubgm_ign === '') {
              this.pubgm_ign_error = 'This field is required.';
          } else {
              this.pubgm_ign_error = '';
          }

          if (this.pubgm_id === '') {
              this.pubgm_id_error = 'This field is required.';
          } else {
              this.pubgm_id_error = '';
          }

          if (this.pubgm_ign_error === '' && this.pubgm_id_error === '') {
