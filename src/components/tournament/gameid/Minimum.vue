  ...
  <div class="mlbb_details">
    <form novalidate>
        <div class="input-wrapper">
            Your team should have minimum {{content.team_limit}} members to join the event.
        </div>
        <router-link class="btn"  tag="button" :to="{ name: 'Teams' ,params: {username: username}}"  exact>ADD</router-link>
    </form>
  </div>
</template>
