  ...
  <div class="mlbb_details">
    <form novalidate>
        <div class="input-wrapper">
            ...
            <div class='validator error' v-if="battle_id_error" >{{battle_id_error}}</div>
        </div>
...
export default {
  ...
  methods: {
      ...
      Save() {
          if (this.battle_id === '') {
              this.battle_id_error = 'This field is required.';
          } else {
              this.battle_id_error = '';
          }

          if (this.battle_id_error === '') {
