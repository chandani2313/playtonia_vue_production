  ...
  <div class="mlbb_details">
    <form novalidate>
        <div class="input-wrapper">
            ...
            <span class="floating-label"   >RAINBOW SIX SEIGE UPLAY ID</span>
            <div class='validator error' v-if="r6_id_error" >{{r6_id_error}}</div>
        </div>
...
export default {
  ...
  methods: {
      ...
      Save() {
          if (this.r6_id === '') {
              this.r6_id_error = 'This field is required.';
          } else {
              this.r6_id_error = '';
          }
          if (this.r6_id_error === '') {
