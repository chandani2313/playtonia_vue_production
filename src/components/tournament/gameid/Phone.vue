      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">Add your mobile number to join the tournament.</div>
                ...
                <div class="table__body">
                    <form novalidate>
                        <div class="input-wrapper">
                            <VuePhoneNumberInput   @update="updatePhoneNumber" :required="true" :error="true"  :dark="true" :dark-color="'#111e2a'" style="font-size:20px; margin-top:20px;" v-model="phone" />
