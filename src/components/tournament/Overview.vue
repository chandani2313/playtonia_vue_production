<template>
  <div class="tournament">
            <div class="eventoverview-eventdetails_wrap" v-if="tournament" >
            <div class="eventdetails_wrap">
              <div class="eventdetails_wrap-details">
                <div class="eventdetails_wrap-details-heading">event details </div>
                <div class="eventdetails_wrap-details-info">
                  <div class="eventdetails_wrap-details-info-eventtype">
                    <div class="eventdetails_wrap-details-info-eventtype-head">Bracket Type :</div>
                    <div class="eventdetails_wrap-details-info-eventtype-details">
                      <div class="eventdetails_wrap-details-info-eventtype-details-icon"><i class="fas fa-sitemap"></i></div>
                      <div class="eventdetails_wrap-details-info-eventtype-details-text">{{bracket}}</div>
                    </div>
                  </div>
                  <div class="eventdetails_wrap-details-info-eventmode">
                    <div class="eventdetails_wrap-details-info-eventtype-head">Event Mode :</div>
                    <div class="eventdetails_wrap-details-info-second-details">
                      <div class="eventdetails_wrap-details-info-second-details-first">
                        <div class="eventdetails_wrap-details-info-eventtype-details-icon"><i class="fas fa-users"></i></div>
                        <div class="eventdetails_wrap-details-info-eventtype-details-text">{{TournamentType}}</div>
                      </div>
                      <div class="eventdetails_wrap-details-info-second-details-second ">online</div>
                    </div>
                  </div>
                  <div class="eventdetails_wrap-details-info-platform-admin">
                    <div class="eventdetails_wrap-details-info-platform">
                      <div class="eventdetails_wrap-details-info-eventtype-head">Platform</div>
                      <div class="eventdetails_wrap-details-info-platform-icon">
                        <img src="../../assets/tournament/smartphone.svg" v-if="tournament.platform === 'MOBILE'">
                        <img src="../../assets/tournament/monitor.svg" v-if="tournament.platform === 'PC'">
                      </div>
                    </div>
                    <!-- <div class="eventdetails_wrap-details-info-admin">
                      <div class="eventdetails_wrap-details-info-eventtype-head">Contact Admin</div>
                      <div class="eventdetails_wrap-details-info-admin-icon">
                        <div class="eventdetails_wrap-details-info-platform-icon-admin" ><i class="fas fa-envelope"></i></div>
                        <div class="eventdetails_wrap-details-info-platform-icon-discord"><i class="fab fa-discord"></i></div>
                      </div>
                    </div> -->
                  </div>
                  <div class="eventdetails_wrap-details-info-country" v-if="!tournament.country_manual">
                    <div class="eventdetails_wrap-details-info-country-flag">
                      <country-flag :country="tournament.country" size='small'/>
                    </div>
                    <div class="eventdetails_wrap-details-info-country-name">{{tournament.country}}</div>
                  </div>
                   <div class="eventdetails_wrap-details-info-country" v-if="tournament.country_manual">
                    <div class="eventdetails_wrap-details-info-country-name manual">{{tournament.country_manual}}</div>
                  </div>

                </div>
              </div>
              <div class="eventdetails_wrap-description">
                <div class="section_bottom_title_wrap">
                  <div class="section_bottom_title_wrap_text">description</div>
                  <router-link class="section_bottom_title_wrap_morebtn" tag="div" :to="{ name: 'Info' ,params: {id: this.$route.params.id}}"  exact>View All</router-link>
                </div>
                <div class="eventdetails_wrap-description-content" v-html="tournament.short_description" >
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  computed: {
    bracket() {
      let Bracket = '';
      if (this.tournament.tournament_mode === 'SE') {
          Bracket = 'SINGLE ELIMINATION';
      } else if (this.tournament.tournament_mode === 'DE') {
          Bracket = 'Double ELIMINATION';
      } else if (this.tournament.tournament_mode === 'RR') {
          Bracket = 'ROUND ROBIN';
      } else if (this.tournament.tournament_mode === 'BR') {
          Bracket = 'BATTLE ROYALE';
      }
      return Bracket;
    },
    TournamentType() {
      let Type = '';
      if (this.tournament.tournament_type === '1') {
          Type = '1 VS 1';
      } else if (this.tournament.tournament_type === '2') {
          Type = '2 VS 2';
      } else if (this.tournament.tournament_type === '3') {
          Type = '3 VS 3';
      } else if (this.tournament.tournament_type === '4') {
          Type = '4 VS 4';
      } else if (this.tournament.tournament_type === '5') {
          Type = '5 VS 5';
      } else if (this.tournament.tournament_type === 'solo') {
          Type = 'SOLO';
      } else if (this.tournament.tournament_type === 'squad') {
          Type = 'SQUAD';
      }
      return Type;
    },
...
.eventdetails_wrap-details-info-country-flag span{
display: block;
}
