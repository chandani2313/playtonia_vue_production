      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                ...
                <div class="table__body">
                   <p>Thank you for joining the tournament.</p>
                   <p>Check your mail for exicting offers on gaming monitors from our sponsor <b>AOC Gaming Monitors</b>.</p>
                   <p>Make sure to check our sponsor <b><a href="https://www.liv.me/">website</a></b>  for exicting offers by clicking the button below.</p>
                   <a href="https://www.liv.me/" target="_blank"><button class="btn">CLICK HERE FOR EXICTING OFFERS</button></a>
                </div>
            </div>
      </div>
  </div>
