<template>
  <div class="info">
    <div class="eventinfo_wrap" v-if="tournament">
      <div class="eventinfo_wrap-content" v-if="tournament.brackets"  v-html="tournament.brackets" >
      </div>
      <div class="eventinfo_wrap-content" v-if="!tournament.brackets">
        Brackets Will Be Updated Soon.
      </div>
    </div>
  </div>
</template>
