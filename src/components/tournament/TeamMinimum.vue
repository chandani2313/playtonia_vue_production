  ...
  <div class="create_team">
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                ...
                <div class="table__body" v-if="game === 'CODM'">
                    You need a COD MOBILE team to join this event,
                    <router-link class="btn"  tag="button" :to="{ name: 'Teams' ,params: {username: username } ,query: { t: 'team'}}"  exact>Create Team</router-link>
                    <div>or</div>
                    <router-link class="btn"  tag="button" :to="{ name: 'AllTeams' }"  exact>Join Team</router-link>
                </div>
                <div class="table__body" v-if="game === 'R6'">
                    You need a RAINBOW SIX SEIGE team to join this event,
                    <router-link class="btn"  tag="button" :to="{ name: 'Teams' ,params: {username: username } ,query: { t: 'team'}}"  exact>Create Team</router-link>
                    <div>or</div>
                    <router-link class="btn"  tag="button" :to="{ name: 'AllTeams' }"  exact>Join Team</router-link>
                </div>
                <div class="table__body" v-if="game === 'PUBGM'">
                    You need a PUBG MOBILE team to join this event,
                    <router-link class="btn"  tag="button" :to="{ name: 'Teams' ,params: {username: username } ,query: { t: 'team'}}"  exact>Create Team</router-link>
                    <div>or</div>
                    <router-link class="btn"  tag="button" :to="{ name: 'AllTeams' }"  exact>Join Team</router-link>
                </div>
