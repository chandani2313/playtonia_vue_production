        ...
        <div class="card" v-if="lobby">
            ...
            <header class="card__header">
                <div class="card__header_text">
                  <h5 class="card__header_text-title">{{lobby.event_data}}</h5>
                  <span class="card__header_textsubtitle"></span>
                </div>
                    ...
                    <div class="lobby_nav_links_details_content">
                      <div class="lobby_nav_links_details_content_inner">
                        ...
                        <div class="detail_contant_first">
                          <!-- <div class="detail_contant_first_img"><img src="img/csgo-icon-42843.png"></div> -->
                          <h5 class="detail_contant_firsth5">CALL OF DUTY MOBILE  5 v 5</h5>
                        </div>
                        <div class="detail_contant_second">
                          <div class="detail_contant_second_top">
                            <span>start time</span>
                            <span>{{lobby.schedule.lobby_match_start_time}}</span>
                          </div>
                          <div class="detail_contant_second_bottom">
                            <span>join before</span>
                            <span>{{lobby.schedule.lobby_ff_time}}</span>
                          </div>
                        </div>
                        <div class="detail_contant_third">
                          <!-- <div class="detail_contant_third_top">
                            <span>map</span>
                            <span>
                              <div class="detail_contant_third_top_map">
                                <img src="https://cdn.faceit.com/games/votables/csgo/maps/de_overpass_110x55.jpg">
                          ...
                          <div class="detail_contant_third_bottom">
                            ...
                            <span>{{lobby.schedule.created_at}}</span>
                          </div>
                          <div class="detail_contant_third_bottom">
                            <span>status</span>
                            <span>{{lobby.schedule.lobby_game_status}}</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card__content_team1">
                <div class="card__content_team1_inner">
                  ...
                  <div class="card__content_team1_inner_team">
                    <h5 class="card__content_team1_inner_team_name">{{lobby.player_data.team1.team_name}}</h5>
                    <span class="card__content_team1_inner_team_subtitle">Team A</span>
                  </div>
                </div>
              </div>
              <div class="card__content_score">
                <span class="win">{{lobby.score.overall_score.t1_score}}</span> - <span class="win">{{lobby.score.overall_score.t2_score}}</span>
              </div>
              <div class="card__content_team2">
                <div class="card__content_team2_inner">
                  ...
                  <div class="card__content_team2_inner_team">
                    <h5 class="card__content_team2_inner_team_name">{{lobby.player_data.team2.team_name}}</h5>
                    <span class="card__content_team2_inner_team_subtitle">Team B</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="lobby_nav_wrapper">
              <div class="lobby_nav">
                <div class="lobby_nav_links">
                  <router-link data-animation="ripple"  tag="a" :to="{ name: 'LobbyOverview' ,params: {id: this.$route.params.lobby_id}}"  active-class="active" exact>overview</router-link>
                  <!-- <a class="" href="#">scoreboard</a> -->
                  <router-link data-animation="ripple" v-if="staff"  tag="a" :to="{ name: 'Admin' ,params: {id: this.$route.params.lobby_id}}"  active-class="active" exact>admin</router-link>
                </div>
              </div>
            </div>
          </div>
