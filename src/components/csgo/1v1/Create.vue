      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">CSGO 1V1 LOBBY CREATION.</div>
                    ...
                    <form novalidate>
                        <div class="input-wrapper">
                            <select>
                                ...
                                <option v-for="tournament in tournaments" :value="tournament.tournament_name" :key="tournament.id">{{tournament.tournament_name}} </option>
                            </select>
