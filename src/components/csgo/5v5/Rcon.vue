      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">SEND RCON COMMAND.</div>
                ...
                <div class="table__body">
                    <form novalidate>
                        <div class="input-wrapper">
                            <input type="text" v-model="rcon" required  placeholder="RCON COMMAND" />
                        </div>
                        <div class="input-wrapper" v-if="messages.length > 0">
                            <div class="message__box" id="m_box">
        ...
        Save() {
            ...
            .then((response) => {
                if (response.status === 200) {
                    this.messages.push(response.data.data.split('/n'));
                    this.$notify({
                        title: 'Success.',
                        group: 'notifications',
