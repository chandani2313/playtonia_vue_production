        ...
        <div class="card" v-if="lobby">
            ...
            <header class="card__header">
                <div class="card__header_text">
                  ...
                  <span class="card__header_textsubtitle" v-if="!lobby.is_active">{{Status}}</span>
                </div>
              ...
              <div class="card__content_team1">
                <div class="card__content_team1_inner">
                  ...
                  <div class="card__content_team1_inner_team">
                    <h5 class="card__content_team1_inner_team_name">{{lobby.teams.team_1.team_name}}</h5>
                    <span class="card__content_team1_inner_team_subtitle">Team A</span>
                  </div>
                </div>
              </div>
              <div class="card__content_score">
                <span class="win">{{lobby.team1_score}}</span> - <span class="win">{{lobby.team2_score}}</span>
              </div>
              <div class="card__content_team2">
                <div class="card__content_team2_inner">
                  ...
                  <div class="card__content_team2_inner_team">
                    <h5 class="card__content_team2_inner_team_name">{{lobby.teams.team_2.team_name}}</h5>
            ...
            <div class="lobby_nav_wrapper">
              <div class="lobby_nav">
                <div class="lobby_nav_links">
                  <router-link data-animation="ripple"  tag="a" :to="{ name: 'Cs5v5Overview' ,params: {id: this.$route.params.lobby_id}}"  active-class="active" exact>overview</router-link>
                  <router-link  data-animation="ripple"  tag="a" :to="{ name: 'Cs5v5Scorecard' ,params: {id: this.$route.params.lobby_id}}"  active-class="active" exact>scorecard</router-link>
                  <router-link v-if="staff" data-animation="ripple"  tag="a" :to="{ name: 'Cs5v5Admin' ,params: {id: this.$route.params.lobby_id}}"  active-class="active" exact>admin</router-link>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...
    Status() {
      ...
      } else if (this.lobby.status === 'pre_match') {
        Stat = 'WAITING FOR PLAYERS';
      } else if (this.lobby.status === 'match_completed') {
        Stat = 'Match Completed';
      } else if (this.lobby.status === 'forefit') {
        Stat = 'Match Forefitted';
      } else if (this.lobby.status === 'match_started') {
