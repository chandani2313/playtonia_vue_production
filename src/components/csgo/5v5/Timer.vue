      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">CHANGE LOBBY TIMER</div>
                ...
                <div class="table__body">
                    <form novalidate>
                        <div class="input-wrapper">
                            <input type="datetime-local" v-model="time" required  placeholder="UPDATE LOBBY MATCH TIME" />
                        </div>
                        <button class="btn" @click.prevent="Save()">UPDATE</button>
                    </form>
                </div>
            </div>
      </div>
...
export default {
  ...
  methods: {
        ...
        Save() {
            axios.post('/csgo/5v5/update_timer', {
                match_start_time: this.time,
