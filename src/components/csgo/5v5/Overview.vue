       ...
       <div class="lobby_player_wrapper">
            <div class="lobby_player_wrapper_inner">
              <div class="lobby_player_wrapper_inner_team1" v-if="lobby">
                  <PlayerCard :data="lb" v-for="lb in lobby.teams.team_1.members" :key="lb.id" />
                  <Empty v-for="i in 5 -  Object.keys(lobby.teams.team_1.members).length" :key="i" />
              </div>
              ...
              <div class="lobby_player_wrapper_inner_team2" v-if="lobby">
                  <PlayerCard :data="lb" v-for="lb in lobby.teams.team_2.members" :key="lb.id" />
                  <Empty v-for="i in 5 - Object.keys(lobby.teams.team_2.members).length" :key="i" />
              </div>
            </div>
       </div>
  </div>
