            ...
            <div class="table__wrapper animated zoomIn">
                ...
                <div class="table__body">
                   <div class="input-wrapper">
                       <span>Search with email id or username.</span>
                        <input v-model="query" placeholder="Search ..." type="text" @keypress="Search()" />
                        <div class="helper" @click="nonmembers()">Player not registered in playtonia ?</div>
                    </div>
                    <div class="result">
                        <PlayerCard v-for="player in players" :key="player.player__id" :player=player @removecard="Search()" />
                    </div>
                </div>
            </div>
      </div>
