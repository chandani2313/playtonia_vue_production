      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">Fill the following fields to join the team.</div>
                ...
                <div class="table__body">
                   <form novalidate>
                        <div class="input-wrapper">
                            ...
                            <span class="floating-label"   >MOBILE LEGENDS IGN</span>
                            <div class='validator error' v-if="mlbb_ign_error" >{{mlbb_ign_error}}</div>
                        </div>
                        <div class="input-wrapper">
                            <input type="number" required v-model="mlbb_id" />
                            <span class="floating-label"   >MOBILE LEGENDS ID</span>
                            <div class='validator error' v-if="mlbb_id_error" >{{mlbb_id_error}}</div>
                        </div>
                        <div class="input-wrapper">
                            <input type="text" required v-model="discord_name" />
                            <span class="floating-label"   >DISCORD NAME (Format Ex: Name#0000)</span>
                            <div class='validator error' v-if="discord_error" >{{discord_error}}</div>
                        </div>
...
export default {
  ...
  methods: {
      ...
      Save() {
          if (this.mlbb_ign === '') {
              this.mlbb_ign_error = 'This field is required.';
          } else {
              this.mlbb_ign_error = '';
          }

          if (this.mlbb_id === '') {
              this.mlbb_id_error = 'This field is required.';
          } else {
              this.mlbb_id_error = '';
          }

          if (this.discord_name === '') {
              this.discord_error = 'This field is required.';
          } else {
              this.discord_error = '';
          }

          if (this.mlbb_ign_error === '' && this.mlbb_id_error === '') {
