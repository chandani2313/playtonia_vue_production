  ...
  <div class="edit">
      <div class="edit_wrapper">
          <div class="form_wrapper">
                <div class="side_menu">
                        <router-link  v-if="profile_data" class="menu-item"  tag="a" :to="{ name: 'Basic' ,params: {username: profile_data } }"  exact>
                            <i class="fas fa-user"></i>Profile Settings
                        </router-link>
                        <router-link  v-if="profile_data" class="menu-item"  tag="a" :to="{ name: 'Game' ,params: {username: profile_data } }"  exact>
                            <i class="fas fa-gamepad"></i>Game Settings
                        </router-link>
                </div>
                <div class="inner_nav">
                    <div class="inner_nav-links">
                        <router-link active-class="active"  v-if="profile_data"   tag="a" :to="{ name: 'Basic' ,params: {username: profile_data } }"  exact>
                            <span>Profile Settings</span>
                        </router-link>
                        <router-link active-class="active"  v-if="profile_data"   tag="a" :to="{ name: 'Game' ,params: {username: profile_data } }"  exact>
