      ...
      <div class="modal__wrapper">
            <div class="table__wrapper animated zoomIn">
                <div class="table__header">
                    <div class="backdrop">
                    <div class="heading">CREATE TEAM</div>
...
export default {
  ...
  methods: {
    ...
    CreateTeam() {
        ...
        if (this.team_name_error === null && this.team_alias_error === null && this.game_error === null && this.country_error === null && this.phone_error === null) {
            axios
