<template>
  <div class="tour">
    <div class="section_bottom_title_wrap">
        ...
        <router-link class="section_bottom_title_wrap_morebtn" tag="div" :to="{ name: 'AllTournament' }"  >View All</router-link>
    </div>
        <div class="section_bottom_wrap_inner">
        <router-link class="event_card animated fadeIn"  v-for="tournament in tournaments.slice(0,4)" :key="tournament.id" tag="div" :to="{ name: 'Tournament' ,params: {id: tournament.id}}"  >
            ...
            <div class="event_card_footer">
                ...
                <div v-if="!tournament.tournament_status.registration_start && tournament.tournament_status.show" class="event_card_footer_sigtxt" ><span>STARTING SOON</span></div>
